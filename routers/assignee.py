...
@router.get("/assignee", response_model=List[assignee_schema.AssigneeResponse])
...
@router.get("/assignee/{assignee_id}", response_model=Optional[assignee_schema.AssigneeResponse])
...
@router.post("/assignee/", response_model=assignee_schema.AssigneeResponse)
...
@router.delete("/assignee/{assignee_id}", response_model=str)
...
@router.put("/assignee/{assignee_id}", response_model=assignee_schema.AssigneeResponse)
